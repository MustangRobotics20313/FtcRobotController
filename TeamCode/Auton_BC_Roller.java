...
@Autonomous(name = "Auton_BC_Roller", group = "Concept")

public class Auton_BC_Roller extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            while (opModeIsActive()) {
                ...
                Vector2d leftSpike = new Vector2d(-3, 30);
                Vector2d middleSpike = new Vector2d(0, 35.5);
                Vector2d rightSpike = new Vector2d(8.25, 29);

                Vector2d leftBoard = new Vector2d(-12, 38);
                Vector2d middleBoard = new Vector2d(-40.5, -5.5);
                Vector2d rightBoard = new Vector2d(-2.5, -45);
                ...
                if (position == "left"){
                    ...
                    TrajectorySequence leftPixelBoard = drive.trajectorySequenceBuilder(startPose)
                            ...
                            .strafeRight(15)
                            .forward(6.5)
                            .splineTo(leftBoard, Math.toRadians(90))
                            .build();

                    drive.followTrajectorySequence(leftPixelBoard);


                    servoBoard.setPosition(0.60);
                    sleep(2000);
                    ...
                    TrajectorySequence rightPixelBoard = drive.trajectorySequenceBuilder(startPose)
                            ...
                            .waitSeconds(0.5)
                            .splineTo(rightBoard, Math.toRadians(270))
                            .build();
