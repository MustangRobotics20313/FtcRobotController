...
@Autonomous(name = "Tensor_BC", group = "Concept")

public class Tensor_BC extends LinearOpMode {
            ...
            while (opModeIsActive()) {
                ...
                if (getRecognition() > 0){
                    ...
                    if (getRecognition() > 0){
                        ...
                        //strafe left to avoid hitting the truss
                        ...
                        //move backwards to prepare for strafing
                        ...
                        //strafe right to avoid hitting the truss
