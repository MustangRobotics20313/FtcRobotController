...
@Autonomous(name = "Old_BF", group = "Concept")
@Disabled

public class Old_BF extends LinearOpMode {
        ...
        if (opModeIsActive() && !isStopRequested() ) {
            while (opModeIsActive()) {
                ...
                if (getRecognition() > 0) {
                    ...
                    drive.setPoseEstimate(startPose);
                    TrajectorySequence middleAdjust = drive.trajectorySequenceBuilder(startPose)
                            .strafeRight(3)
                            .build();

                    drive.followTrajectorySequence(middleAdjust);
                    ...
                    if (getRecognition() > 0){
                        ...
                        drive.setPoseEstimate(startPose);
                        TrajectorySequence leftAdjust = drive.trajectorySequenceBuilder(startPose)
                                .strafeRight(3)
                                .build();
                        ...
                        drive.setPoseEstimate(startPose);
                        TrajectorySequence rightAdjust = drive.trajectorySequenceBuilder(startPose)
                                .strafeRight(3)
                                .build();
