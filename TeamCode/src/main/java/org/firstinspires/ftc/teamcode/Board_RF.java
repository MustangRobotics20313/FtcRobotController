...
@Autonomous(name = "Board_RF", group = "Concept")

public class Board_RF extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            while (opModeIsActive()) {
                ...
                Vector2d leftBoard = new Vector2d(2, -81);
                Vector2d middleBoard = new Vector2d(86, 27);
                Vector2d rightBoard = new Vector2d(5, 87);
                ...
                if (position == "left"){
                    ...
                    drive.setPoseEstimate(startPose);
                    TrajectorySequence adjustLeftPixel = drive.trajectorySequenceBuilder(startPose)
                            .forward(-2)
                            .build();

                    drive.followTrajectorySequence(adjustLeftPixel); */
                    ...
                    drive.setPoseEstimate(startPose);
                    TrajectorySequence adjustMiddlePixel = drive.trajectorySequenceBuilder(startPose)
                            .forward(-2)
                            .build();

                    drive.followTrajectorySequence(adjustMiddlePixel); */
                    ...
                    drive.setPoseEstimate(startPose);
                    TrajectorySequence adjustRightPixel = drive.trajectorySequenceBuilder(startPose)
                            .forward(-2)
                            .build();

                    drive.followTrajectorySequence(adjustRightPixel); */
