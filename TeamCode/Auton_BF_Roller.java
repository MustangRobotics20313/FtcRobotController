...
@Autonomous(name = "Auton_BF_Roller", group = "Concept")

public class Auton_BF_Roller extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive() && !isStopRequested()) {
            while (opModeIsActive()) {
                ...
                Vector2d leftBoard = new Vector2d(4.5, 83);
                Vector2d middleBoard = new Vector2d(83, -3);
                Vector2d rightBoard = new Vector2d(5, -80);
